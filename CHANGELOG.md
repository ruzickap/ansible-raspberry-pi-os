...
* migrate secrets from ansible-vault to environment variables ([#278](https://github.com/ruzickap/ansible-raspberry-pi-os/issues/278))
...
* add prometheus settings ([#258](https://github.com/ruzickap/ansible-raspberry-pi-os/issues/258)) ([b81e4c4](https://github.com/ruzickap/ansible-raspberry-pi-os/commit/b81e4c440f1129e36103fcc94ee3386a8c2b970f))
...
* add tags to roles/tasks and conditional reboot handler ([#280](https://github.com/ruzickap/ansible-raspberry-pi-os/issues/280)) ([6d8fa60](https://github.com/ruzickap/ansible-raspberry-pi-os/commit/6d8fa60fcd5c0876b6aeac9a0afce020708aa5a4))
...
* **ansible:** update guisettings and unattended upgrades configuration ([#253](https://github.com/ruzickap/ansible-raspberry-pi-os/issues/253)) ([31328d3](https://github.com/ruzickap/ansible-raspberry-pi-os/commit/31328d3f1b76f0988c203f196c959c87cc979c22))
* enable home assistant, homepage and firewalld ([#285](https://github.com/ruzickap/ansible-raspberry-pi-os/issues/285)) ([2541d02](https://github.com/ruzickap/ansible-raspberry-pi-os/commit/2541d029665c2997f8b2859f04a6453e83b1f801))
...
* migrate secrets from ansible-vault to environment variables ([#278](https://github.com/ruzickap/ansible-raspberry-pi-os/issues/278)) ([523e9e6](https://github.com/ruzickap/ansible-raspberry-pi-os/commit/523e9e603960003ea53ca20b965b7be09c7d5e5f))
...
* update WiFi configuration to use wlan1 - USB WiFi ([#268](https://github.com/ruzickap/ansible-raspberry-pi-os/issues/268)) ([11d303f](https://github.com/ruzickap/ansible-raspberry-pi-os/commit/11d303f72c3136856dd47aec8950da3a80c85d48))
* upgrade alloy to 1.16.0 and expand metrics collection ([#276](https://github.com/ruzickap/ansible-raspberry-pi-os/issues/276)) ([14738d2](https://github.com/ruzickap/ansible-raspberry-pi-os/commit/14738d2d1ef1397e4c54456492d92a6a86a003bd))


### Bug Fixes

* add Raspberry Pi integration for node exporter ([#256](https://github.com/ruzickap/ansible-raspberry-pi-os/issues/256)) ([57a58ff](https://github.com/ruzickap/ansible-raspberry-pi-os/commit/57a58fff47f50257d85add5d0d1d7a3af2001599))
* disable Bluetooth and correct Homepage icon ([#295](https://github.com/ruzickap/ansible-raspberry-pi-os/issues/295)) ([2f27dbc](https://github.com/ruzickap/ansible-raspberry-pi-os/commit/2f27dbcd9987deaec44c0928edd2303b1382e7aa))
